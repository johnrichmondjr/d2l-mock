...
public interface AssignmentRepository extends JpaRepository<Assignment, Long>{
    ...
    @Query("SELECT new edu.depaul.cdm.se452.d2l_mock.submission.dto.AssignmentDTO(a.id, a.score, a.name, a.dueDate, a.course.id, a.course.name, a.student.id) FROM Assignment a WHERE a.course.id = :courseId")
